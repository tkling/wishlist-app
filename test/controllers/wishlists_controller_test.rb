...
class WishlistsControllerTest < ActionController::TestCase
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post :create, wishlist: { description: @wishlist.description, owner: @wishlist.owner, title: @wishlist.title }
    end
  ...
  test "should update wishlist" do
    patch :update, id: @wishlist, wishlist: { description: @wishlist.description, owner: @wishlist.owner, title: @wishlist.title }
    assert_redirected_to wishlist_path(assigns(:wishlist))
  end
