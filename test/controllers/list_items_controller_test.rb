...
class ListItemsControllerTest < ActionController::TestCase
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post :create, list_item: { name: @list_item.name, notes: @list_item.notes, url: @list_item.url, wishlist_id: @list_item.wishlist_id }
    end
  ...
  test "should update list_item" do
    patch :update, id: @list_item, list_item: { name: @list_item.name, notes: @list_item.notes, url: @list_item.url, wishlist_id: @list_item.wishlist_id }
    assert_redirected_to list_item_path(assigns(:list_item))
  end
